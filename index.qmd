...
```{python}
# Load the data
emissions = pd.read_csv("C:\\Users\\dosuka\\Documents\\GitHub\\co2_emissions_demo\\Data\\co2_cons.csv")
```
...
selected_countries = ["Mexico", "Austria", "Canada", "Kenya", "Samoa"]

# Filter for these countries
emissions_long_subset =  emissions_long.query("country in @selected_countries")
...
fig = px.line(
    ...
    y="emissions", 
    color="country",
    title="Emissions Trend (1990-2022)",
    labels={"emissions": "Total Emissions", "year": "Year"},
    line_shape="spline",  # Makes curves smoother
    markers=True  # Adds points to the lines
)
